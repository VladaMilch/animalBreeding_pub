...
required_F100 %>%
  ...
  labs(x="Required number of pups", 
       ...
       caption = "Mean litter size: 7,  Effective fertility: 100%", 
       title = "Model comparison for the smallest required number of breegins", colour = "Method") + 
  theme(legend.position="right") 

  
save(required_F100, file = "required_fertility100.RData")

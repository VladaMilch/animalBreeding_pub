...
Therefore, I did not round the value above to the smallest integer that 
guarantees $P\geq 0.975$ - in the case above that would be 11.
...
breedings required to give 97.5/% probability of achieving more than ten 
litters,  with the effective fertility being 15 per cent, is 119 (according to 
the textbook). 

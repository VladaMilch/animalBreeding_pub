...
nneeded = function(goodKO,goodWT,ppower=0.9,pgoodKO=0.0625,pgoodWT=0.0625,Nmax=1000){
...
image(t(neededmat))
contour(1:maxgood,1:maxgood,neededmat,nlevels=15,ylab = "required number of animals for experiment 0.0625 probability", xlab = "required number of animals for experiment 0.0625 probability.")
...
ALL
write.csv(ALL, file = "ALLrequiredno00625twogroups")
...
EQUAL
write.csv(EQUAL, file = "EQUALrequiredno00625twogroups")
MENDEL <- c(1:15)/0.0625
MENDEL
plot(EQUAL, ylim=c(1,350), ylab = "required number of born animals", xlab = "required number of animals for experiment (size group A = size group B)", main = "0.0625 genotype probability", pch = 19, cex = 1.2)
points(MENDEL, pch = 2)

...
nneeded05 = function(goodKO05,goodWT05,ppower05=0.8,pgoodKO05=0.5,pgoodWT05=0.5,Nmax05=100){
  prelativ05 = pgoodKO/(pgoodKO+pgoodWT)
  pgoodtota05l = pgoodKO05 + pgoodWT05
  totalgood05 = goodKO+goodWT
